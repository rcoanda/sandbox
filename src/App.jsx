...
import { DicoProvider } from './composants/globals/Dico'
import Home from './pages/globals/Home'
import About from './pages/globals/About'
import Contact from './pages/globals/Contact'
import Ellipse from './pages/Trajectoires/Ellipse'
import Terre from './pages/GaleriesApi/Terre'
import Archive from './pages/globals/Archive'
...
import PhoenixSVG from './pages/Graphisme/PhoenixSVG'
  ...
  return (
    <DicoProvider>
      <Routes>
        ...
        <Route path="/phoenixsvg" element={<PhoenixSVG />} />
